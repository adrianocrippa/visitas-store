// =====================================================
// LANDING PAGE COMERCIAL - VERSÃO CORRIGIDA
// =====================================================
    ...
    <section id="about" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Conheça a história por trás da CatalogPro
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-gray-600 mb-6">
              Especialista em soluções web modernas, com foco em React, Node.js e Supabase. 
              Apaixonado por criar ferramentas que simplificam a vida dos empreendedores.
            </p>
          ...
          <div>
            <h4 className="text-xl font-semibold text-gray-900 mb-4">A História da CatalogPro</h4>
            <div className="space-y-4 text-gray-600">
              <p>
                A ideia da CatalogPro nasceu da necessidade real de vendedores que lutavam 
                para apresentar seus produtos de forma profissional. Muitos ainda dependiam 
                de planilhas Excel estáticas e catálogos impressos desatualizados.
              </p>
              <p>
                Como desenvolvedor, vi uma oportunidade de criar uma solução que fosse 
                simples de usar, mas poderosa o suficiente para transformar completamente 
                a experiência de vendas B2B.
              </p>
              <p>
                Hoje, a CatalogPro ajuda centenas de vendedores a criar catálogos 
                profissionais em minutos, não em dias. É mais do que uma ferramenta - 
                é uma revolução na forma como produtos são apresentados.
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://twitter.com/catalogpro" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://facebook.com/catalogpro" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition duration-200"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:help@catalogpro.com" className="text-gray-400 hover:text-white transition duration-200">Central de Ajuda</a></li>
              <li><a href="https://docs.catalogpro.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition duration-200">Documentação</a></li>
              <li><a href="mailto:contato@catalogpro.com" className="text-gray-400 hover:text-white transition duration-200">Contato</a></li>
              <li><a href="https://status.catalogpro.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition duration-200">Status</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            ...
            Desenvolvido por <a href="https://home.adrianocrippa.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">Adriano Crippa</a>
          </p>
        </div>
      </div>
    </footer>
